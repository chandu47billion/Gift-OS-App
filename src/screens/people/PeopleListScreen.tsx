...
export default function PeopleListScreen({ navigation }: { navigation: any }) {
  ...
  const nextOccasionLabel = (personId: string) => {
    const person = state.people.find((p) => p.id === personId);
    if (!person || person.occasions.length === 0) return undefined;

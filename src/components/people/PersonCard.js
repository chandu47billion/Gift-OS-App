...
function PersonCard({ person, nextOccasionLabel, onPress }) {
  ...
  return <Card onPress={onPress} style={styles.card}>
      ...
      {nextOccasionLabel ? <Text style={[styles.occasion, { color: theme.colors.textSecondary }]} numberOfLines={1}>
          🎉 {nextOccasionLabel}
        </Text> : null}
    </Card>;
}

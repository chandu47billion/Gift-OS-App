...
const wishlist = [
  { id: "w1", personId: "p1", name: "Leather Journal", price: 42, emoji: "\u{1F4D3}", purchased: false, url: "https://example.com/journal" },
  { id: "w2", personId: "p1", name: "Matcha Gift Set", price: 28, emoji: "\u{1F375}", purchased: false },
  { id: "w3", personId: "p2", name: "Wireless Gaming Headset", price: 129, emoji: "\u{1F3A7}", purchased: false },
  { id: "w4", personId: "p3", name: "Ceramic Tea Set", price: 55, emoji: "\u{1F376}", purchased: true },
  { id: "w5", personId: "p5", name: "Trail Running Shoes", price: 98, emoji: "\u{1F45F}", purchased: false }
];
const giftHistory = [
...
const notifications = [
  { id: "n1", title: "Emma's Birthday in 11 days", body: "Start planning the perfect gift now.", time: "2h ago", read: false, icon: "\u{1F382}" },
  { id: "n2", title: "New gift idea for Sophie", body: "Trail Running Shoes matches her interests.", time: "5h ago", read: false, icon: "\u{1F381}" },
  { id: "n3", title: "Budget alert", body: "You've used 70% of Emma's gift budget.", time: "1d ago", read: true, icon: "\u{1F4B0}" },
  { id: "n4", title: "Reminder set", body: "We'll remind you 7 days before Mom's birthday.", time: "2d ago", read: true, icon: "\u{1F514}" }
];
const discoverCategories = ["All", "Tech", "Fashion", "Home", "Experiences", "Books", "Jewelry"];
const relationshipFilters = ["All", "Family", "Friend", "Partner", "Colleague", "Other"];
export {
  budget,
  discoverCategories,
  giftHistory,
